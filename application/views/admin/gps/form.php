<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('admin/gps'); ?>">Data GPS</a></li>
            ...
            <div class="card card-outline-danger">
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form class="form-valide" action="<?php echo base_url('admin/gps/save_gps'); ?>" enctype="multipart/form-data" method="POST">
                            <div class="form-body">
