                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php if(($pengguna->name)==null){ echo '<strong style="color: red;">Annonymous</strong>'; } else { echo ''.ucwords($pengguna->name).''; } ?> <img src="<?php if(!empty($pengguna->photo)){echo base_url('files/users/'.$pengguna->id_user.'/'.$pengguna->photo);}else{ echo base_url('files/no_image.png');}?>" alt="user" class="profile-pic" /></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="#" href="<?php echo base_url('user/dashboard'); ?>" aria-expanded="false"><i class="fa fa-tachometer"></i>Dashboard </a>
                        </li>
                        </li>
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-database"></i><span class="hide-menu">Manage GPS</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('user/gps'); ?>">Data GPS</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
