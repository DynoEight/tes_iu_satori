            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?php echo base_url('user/gps/form'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="<?php echo base_url('user/gps/form/'.$row->id_gps); ?>" class="btn btn-warning btn-xs" title="Edit Data"><i class="fa fa-edit"></i></a>
                                            ...
                                            <a href="<?php echo base_url('user/gps/delete/'.$row->id_gps); ?>" class="btn btn-danger btn-xs" onClick="return confirm('Apakah Anda ingin menghapus data gps ini?')" title="Hapus Data"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
